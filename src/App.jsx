...
function ServiceCard({ service, reducedMotion }) {
  const cardHover = reducedMotion ? undefined : { y: -8, scale: 1.02 };
    ...
    >
      ...
      <div className="hm-card-content">
        <div className="hm-card-image-wrap">
          ...
          <span
            className="hm-card-badge"
            style={{ color: service.accentSolid, borderColor: service.accent }}
          >
            {service.badge}
          </span>
        </div>
        ...
        <div className="hm-card-body">
          <p className="hm-eyebrow" style={{ color: service.accentSolid }}>
            {service.title}
          </p>
          ...
          <div className="hm-chip-row">
            {service.chips.map((chip) => (
              <span key={chip} className="hm-chip">
                {chip}
              </span>
            ))}
          </div>
          ...
          <a
            href={service.href}
            className="hm-btn mt-auto"
            style={{ "--btn-color": service.accentSolid }}
          >
    ...
    <div className="hm-app">
      ...
      <main className="hm-main">
          ...
          <div className="hm-container">
            ...
            >
              <motion.div variants={itemVariants} className="hm-hero-pill">
                ...
                Hover over this section for a surprise!
              </motion.div>
        ...
        <section className="hm-services">
          <div className="hm-container">
            <div className="hm-sec2-title">
              Select your niche and continue exploring
            </div>
      ...
      <footer className="hm-footer">
        <div className="hm-container">
          <p>
            © {new Date().getFullYear()} Project Studio. Crafted for excellence.
          </p>
        </div>
      </footer>
    </div>
